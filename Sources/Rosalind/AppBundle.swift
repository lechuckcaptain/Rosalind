...
struct AppBundle: Equatable {
    ...
    struct InfoPlist: Decodable, Equatable {
        ...
        init(from decoder: any Decoder) throws {
            ...
            // macOS bundles use LSMinimumSystemVersion, iOS/tvOS/watchOS/visionOS use MinimumOSVersion
            if let version = try container.decodeIfPresent(String.self, forKey: .minimumOSVersion) {
                minimumOSVersion = version
            } else {
                minimumOSVersion = try container.decode(String.self, forKey: .minimumSystemVersion)
            }
